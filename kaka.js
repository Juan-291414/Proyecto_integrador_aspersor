 // Clase que encapsula los cálculos del sistema de microaspersión
        ...
        class Terreno {
            ...
            mostrarInfo() {
                ...
                console.log(`Altura del Depósito: ${this.alturaDeposito} m`); // Mostrar también la altura del depósito
        ...
        class Usuario {
            ...
            accederPanel() {
                ...
                mostrarSeccion("inicioSection"); // Esto debería ser más específico para cada rol
            }
            ...
            static crearTerrenoDesdeAdminFormulario() {
                ...
                const adminAlturaDepositoInput = document.getElementById("adminAlturaDeposito"); // Nuevo input para la altura del depósito
                const mensajeAdminCrearTerreno = document.getElementById("mensajeAdminCrearTerreno");

                if (!formAdminCrearTerreno || !adminAnchoTerrenoInput || !adminLargoTerrenoInput || !adminAlturaDepositoInput || !mensajeAdminCrearTerreno) {
                ...
                formAdminCrearTerreno.addEventListener("submit", (e) => {
                    ...
                    const alturaDeposito = parseFloat(adminAlturaDepositoInput.value); // Obtener la altura del depósito

                    try {
                        // Pasar la altura del depósito al constructor de Terreno
                        const nuevoTerreno = new Terreno(ancho, largo, alturaDeposito);
                        mensajeAdminCrearTerreno.textContent = `Terreno ${nuevoTerreno.id} (Área: ${nuevoTerreno.area}m², Depósito: ${nuevoTerreno.alturaDeposito}m) creado con éxito.`;
        ...
        class Campesino extends Usuario {
            ...
            accederPanel() {
                if (Usuario.usuarioActual && Usuario.usuarioActual.rol === "campesino") {
                    ...
                    const simulacionAlturaMostradaSpan = document.getElementById("simulacionAlturaMostrada"); // Para mostrar la altura del depósito
                    ...
                    if (infoTerrenoCampesinoSpan) {
                        if (this.terrenoAsignado) {
                            ...
                            // Mostrar u ocultar la sección de simulación
                            if (simulacionContainer) simulacionContainer.classList.remove('hidden');
                            // Actualizar la altura mostrada en la simulación
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Actualizar selects para asignación de terrenos (se llama al inicio)
            Usuario.actualizarSelectAsignarTerreno();
            ...
            // Definir sección de inicio para el navbar (redirecciona al panel del rol)
            document.getElementById('navInicio').addEventListener('click', (e) => {
                ...
                if (Usuario.usuarioActual) {
                    if (Usuario.usuarioActual.rol === "administrador") {
                        ...
                        // Al volver al panel del campesino, refrescar la información
            ...
            if (formSimuladorCampesino) {
                formSimuladorCampesino.addEventListener("submit", function (e) {
                    ...
                    // La altura se obtiene del terreno asignado, no de un input directo del usuario en este formulario
                    ...
                    // Validación básica solo para tiempo
                    if (isNaN(tiempo) || tiempo <= 0) {
                        if (resultadosSimulacionDiv) {
                            resultadosSimulacionDiv.innerHTML = "Por favor, introduce un valor válido y mayor que cero para el Tiempo de aspersión.";
                        }
                        return;
                    }

                    // Asegurarse de que el usuario actual es un campesino y tiene un terreno asignado
                    if (Usuario.usuarioActual instanceof Campesino && Usuario.usuarioActual.terrenoAsignado) {
                        // Crear instancia del sistema de microaspersión con el terreno asignado del campesino
                        // y el tiempo. La altura se obtiene internamente de 'terreno.alturaDeposito' a través del getter.
                        ...
                        if (resultadosSimulacionDiv) {
                            resultadosSimulacionDiv.innerHTML = "No tienes un terreno asignado o no eres un Campesino para realizar la simulación.";
                        }
                    }
                });
            }
